...
import jeka.tsen.shopping_cart_dream_shop.enums.OrderStatus;
...
import jeka.tsen.shopping_cart_dream_shop.model.OrderItem;
import jeka.tsen.shopping_cart_dream_shop.model.Product;
import jeka.tsen.shopping_cart_dream_shop.repository.OrderRepository;
import jeka.tsen.shopping_cart_dream_shop.repository.ProductRepository;
import jeka.tsen.shopping_cart_dream_shop.service.cart.CartService;
...
public class OrderService implements IOrderService {
    ...
    public OrderDto getOrder(Long orderId) {
        return orderRepository.findById(orderId)
                ...
                .orElseThrow(() -> new ResourseNotFoundException("Order not found"));
    }
